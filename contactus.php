...
<html>
  ...
  <head>
    <title> Contact | Food Mania</title>
  </head>
...
?>
    ...
    <div class="heading">
     Want To Contact <span class="edit"> Food Mania </span>?
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; text-transform:uppercase;"> Contact Form</h3>
